...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ST_MACRO_0,     CW_TOGG,        ST_MACRO_1,     KC_NO,          KC_BRIGHTNESS_DOWN,KC_BRIGHTNESS_UP,                                KC_MEDIA_PREV_TRACK,KC_MEDIA_PLAY_PAUSE,KC_MEDIA_NEXT_TRACK,KC_AUDIO_MUTE,  KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,
  ...
  [4] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          RGB_VAD,        RGB_VAI,                                        KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    LALT(KC_3),     KC_LEFT_GUI,    RU_MINS,        LALT(LSFT(KC_4)),RU_RUBL,        RU_UNDS,                                        KC_KP_PLUS,     KC_7,           KC_8,           KC_9,           KC_KP_ASTERISK, LALT(KC_6),     
    TD(DANCE_9),    RU_DQUO,        LALT(KC_7),     RU_EXLM,        RU_QUES,        RU_COLN,                                        KC_KP_MINUS,    KC_4,           KC_5,           KC_6,           KC_KP_SLASH,    RU_BSLS,        
    KC_TRANSPARENT, KC_LEFT_ALT,    TD(DANCE_10),   TD(DANCE_11),   TD(DANCE_12),   RU_SCLN,                                        KC_KP_EQUAL,    MT(MOD_RGUI, KC_1),MT(MOD_RSFT, KC_2),MT(MOD_RCTL, KC_3),MT(MOD_LALT, KC_KP_DOT),KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_0
  ),
  [5] = LAYOUT_voyager(
    KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_F6,                                          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         KC_F12,         
    ...
    KC_TRANSPARENT, KC_LEFT_ALT,    TD(DANCE_13),   TD(DANCE_14),   TD(DANCE_15),   KC_NO,                                          KC_NO,          TD(DANCE_16),   TD(DANCE_17),   KC_RIGHT_CTRL,  KC_LEFT_ALT,    KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    if (record->event.pressed) {
      SEND_STRING(SS_LALT(SS_LCTL(SS_LSFT(SS_TAP(X_SPACE)))));
    }
    break;
    case ST_MACRO_1:
    if (record->event.pressed) {
...
void dance_9_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[9].step) {
        case SINGLE_TAP: register_code16(LALT(RU_ZE)); break;
        case SINGLE_HOLD: register_code16(KC_LEFT_ALT); break;
        case DOUBLE_TAP: register_code16(LALT(RU_ZE)); register_code16(LALT(RU_ZE)); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LALT(RU_ZE)); register_code16(LALT(RU_ZE));
    }
}
...
void dance_9_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[9].step) {
        case SINGLE_TAP: unregister_code16(LALT(RU_ZE)); break;
        case SINGLE_HOLD: unregister_code16(KC_LEFT_ALT); break;
        case DOUBLE_TAP: unregister_code16(LALT(RU_ZE)); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LALT(RU_ZE)); break;
    }
